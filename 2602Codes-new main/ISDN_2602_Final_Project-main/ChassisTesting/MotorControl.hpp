...
namespace Motion{
  ...
  void Boost(uint16_t B_LeftSpeed, uint16_t B_RightSpeed);
  ...
  void Fol_Rightwards(uint16_t LeftSpeed, uint16_t RightSpeed);
  void Fol_Leftwards(uint16_t LeftSpeed, uint16_t RightSpeed);
};
